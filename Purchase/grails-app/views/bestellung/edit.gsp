...
<html>
	...
	<body>
		...
		<div id="edit-bestellung" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${bestellungInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${bestellungInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:bestellungInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${bestellungInstance?.version}" />
				<fieldset class="form">
